    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-2xl mx-auto p-10 boxes">
        <div class="shadow-xl rounded-2xl overflow-hidden">
          <!-- Header -->
          <div class="px-6 py-8">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Update User</h2>
            <p class="text-gray-600 dark:text-gray-300 mt-2">Fill in the details to update the user</p>
          </div>
        ...
        try {
            ...
            if (response && response.data) {
                ...
                this.form = {
                    ...
                    role: userData.role ? userData.role.toString() : '1',
                    password: '',
                }
                console.log('Form populated with:', this.form) // Debug log
            } else {
